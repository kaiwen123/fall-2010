...
\begin{figure}[H]
  \vspace{-10pt}
  \begin{center}
    \pstree[levelsep=10ex]{\Toval{salary}}{
      \Toval{senior}\tlput{High}
      \Toval{TBD}\tvput{Medium}
      \Toval{junior}\trput{Low}
    }
...
\begin{figure}[H]
  ...
  \begin{center}
    \pstree[levelsep=10ex]{\Toval{salary}}{
      \Toval{senior}\tlput{High}
      \pstree{\Toval{department}\tvput{Medium}} {
        \Toval{senior}\tlput{sales}
        \Toval{junior}\tlput{junior}
        \Toval{TBD}\tvput{marketing}
        \Toval{senior}\trput{secretary}
      }
      \Toval{junior}\trput{Low}
    }
