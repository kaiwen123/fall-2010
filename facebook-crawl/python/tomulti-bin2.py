...
# everyone: 2
#############################################################
# After getting values from the above rule, the transform the data into 
# binary types, 
# for everybody + fof --> 0; and for others --> 1; 
    ...
    if nobodydata.has_key(key):
        ...
        if len(binuser) == len(binnobody) and len(binuser) == 28:
            ...
            for i in range(length):
                ...
                bu = binuser[i]
                bn = binnobody[i]
                if bu == 'Y' and bn == 'Y': result += '0,'
                if bu == 'Y' and bn == 'N': result += '0,'
                if bu == 'N' and bn == 'Y': result += 'x,' # impossible, remove it from data. 
                if bu == 'N' and bn == 'N': result += '1,'
