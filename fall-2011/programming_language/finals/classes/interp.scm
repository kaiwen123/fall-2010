  ...
  (define value-of
    (lambda (exp env)
	  ...
	  (proc-val
        ...
        ;; list-exp was modified for the queue class.        
        (list-exp (exps)
          (list-val
            (values-of-exps exps env)))
        ;;;;;;;;;;;;;;;;;;; list changes from here. 
        ;; test if list is empty, for empty?() in queue. 
;        (list-empty?-exp (exps)
;          (null? (value-of-exps exps env)))

        ;; new cases for CLASSES language
        ;; we used the new find-method that allows method overloading.
        ;; (length rands) is added to the find method function call.
        ...
        ;; Similar to the new-object-exp, we also add (length rands) to 
        ;; the find-method function call. 
        ...
        ;; added (length rands) to the find-method function call.
