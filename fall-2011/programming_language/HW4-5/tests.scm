...
1)
  ...
  ;; class bogus-oddeven. 
  ;; This is Execise 9.2 of EOPL3. --> the first question of hwk4.  
  ;; overide the even method of oddeven and return a wrong answer. 
  ;; For test purposes, we always put the correct answer for test result 
  ;; comparison. For example, the result of odd(13) should be 1, and our
  ;; overloaded method should return 1, and it will not pass the test. 
  (bogus-oddeven "
class oddeven extends object 
  method initialize()1
...
let o1 = new bogus-oddeven() in send o1 odd(13)"
  ...
  ;;; test case for named-method-call-exp. 
  ;;; static dispatch. 
  ;;; in the following example, m2 of c2 will be called 
  ;;; although o3 is an object of c3. 
  (named-method-call "
class c1 extends object
 method initialize () 1
 method m2() 12
